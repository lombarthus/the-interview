...
const STEP_NAMES = { system: 'Systemcheck (GPU, Platz, Werkzeuge)', ffmpeg: 'ffmpeg (Audio/Video-Werkzeug, ≈ 110 MB)', python: 'Python 3.11 in eigener Umgebung (≈ 25 MB)', torch: 'torch (GPU: CUDA 13, ≈ 3 GB · CPU: ≈ 250 MB)', packages: 'Sprach-Engine (OmniVoice / Pocket TTS / Whisper)', models: 'Modelle laden (GPU: ≈ 6,6 GB · CPU: ≈ 0,9 GB)' };
const PROVIDERS = [
